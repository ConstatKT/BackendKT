...
exports.register = async (req, res) => {
  ...
  if (await User.findOne({ email })) {
    ...
    nouveauUser.adresse = adresse;
    nouveauUser.tel = tel;
    nouveauUser.cin = cin;
    nouveauUser.categorie_permis = categorie_permis;
    nouveauUser.date_permis = date_permis;
...
exports.editProfile = async (req, res) => {
  const { username,cin,tel,adresse,role, email } = req.body;
